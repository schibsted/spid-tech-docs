...
The `addresses` property uses a common Schibsted account data structure, the "object of
...
a failure. Schibsted account is generally email address aliases (e.g.
...
broken. To send the user to Schibsted account to pay through a paylink, either use a regular
