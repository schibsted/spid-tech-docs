...
In order to use the Android Schibsted account SDK, you must fist install the
...
build the Schibsted account Android SDK.
...
When the emulator is running, run the Schibsted account example app ('SPiDExampleApp'):
...
To use the Schibsted account Android SDK you must first make the library available to your
application. Add the Schibsted account SDK as a dependency to your pom.xml:
