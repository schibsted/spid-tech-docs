...
SchAcc flows are separated into different flows, that can be trigged by you by using different urls.
...
* update design, to reduce the SchAcc branding,
...
This prototype is available at http://preview.spid.se. Each row is a variant of a flow found in SchAcc.
