/* This is a modified version of js-sequence-diagrams
 * to get theme that matches SPiD.
 *
 * I spent quite a while trying to wrangle the built in theme-support to do
 * anything useful, and failed. This manually monkey patched file is a testament
 * to my failure, and that of the theme system in js-sequence-diagrams.
 */
...
(function () {
    ...
    _.extend(BaseTheme.prototype, {
        ...
        draw_rect : function(x, y, w, h, options) {
            return this._paper.rect(x, y, w, h, options && options.rectRadius ? options.rectRadius : 0);
        },
        ...
        layout : function() {
            ...
            actorFont._obj=this._paper.getFont("Ubuntu")

            _.each(actors, function(a) {
                var bb = paper.text_bbox(a.name, actorFont);
                a.text_bb = bb;
        ...
        draw_actor : function (actor, offsetY, height) {
            actor.y      = offsetY;
            actor.height = height;
            this.draw_text_box(actor, actor.name, ACTOR_MARGIN, ACTOR_PADDING, actorFont, {rectRadius: 5, rectAttrs: {fill: "#ccccff"}});
        },
        ...
        draw_signal : function (signal, offsetY) {
            ...
            this.draw_text(x, y - 2, signal.message, this._font, {drawRect: true});
         ...
         */
        draw_text : function (x, y, text, font, options) {
            var paper = this._paper;
            var f = font || {};
            var t;
            if (f._obj) {
        ...
        draw_text_box : function (box, text, margin, padding, font, options) {
            var x = box.x + margin;
            var y = box.y + margin;
            ...
            // Draw inner box
            var rect = this.draw_rect(x, y, w, h, options);
            rect.attr(options && options.rectAttrs ? options.rectAttrs : LINE);
    ...
    _.extend(RaphaelTheme.prototype, BaseTheme.prototype, {
        ...
        init_font : function() {
            ...
            this._font._obj=this._paper.getFont("Ubuntu")
